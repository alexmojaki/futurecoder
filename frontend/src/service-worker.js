...
if (process.env.NODE_ENV === "production" || process.env.NODE_NEV === "dev-pwa") {
  registerRoute(
    ({url}) => {
      ...
      if (urlString.startsWith('https://cdn.jsdelivr.net/')) {
        ...
        return true;
      } else if (urlString.startsWith('https://stackpath.bootstrapcdn.com/bootstrap/')) {
        // TODO: move bootstrap inline rather than getting from CDN
        return true;
      } else if (urlString.startsWith('https://futurecoder.io')) {
        return true;
      } else if (urlString.startsWith('https://fonts.googleapis.com')) {
        return true;
