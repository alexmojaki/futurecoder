...
from core.runner.utils import format_traceback_string
...
class Runner:
    def __init__(
        ...
        *,
        extra_locals=None,
        format_traceback=format_traceback_string,
        format_syntax_error=None,
        serialize_traceback=None,
        ...
        self.format_syntax_error = format_syntax_error or format_traceback
        self.serialize_traceback = serialize_traceback
    ...
    def execute(self, code_obj):
        try:
            ...
            extra = {}
            if self.serialize_traceback:
                extra["data"] = self.serialize_traceback(e)
            self.output_buffer.put("traceback", self.format_traceback(e), **extra)
    ...
    def inner_run(self, run_type, source_code):
        ...
        friendly_traceback.source_cache.cache.add(filename, source_code)
